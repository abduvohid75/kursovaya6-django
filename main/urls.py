...
from main.views import home, UserCreateView, MailCreateView, MailListView, MailDeleteView, MailDetailView, UserListView, UserUpdateView, UserDeleteView, SuccessMailListView
